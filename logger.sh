#!/bin/bash
# mpstat uses package sysstat

#First we take our base readings
CPU_READING=$(cat /sys/class/thermal/thermal_zone0/temp)    #Did not need anything extra
#CPU_UTILIZATION_RAW=$(mpstat -P ALL --dec=0)    #using package: sysstat
